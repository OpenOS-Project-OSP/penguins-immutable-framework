...
|---|---|---|---|
| pif → recovery | [penguins-recovery](https://gitlab.com/openos-project/penguins-eggs_deving/penguins-recovery) | Pre-upgrade | `penguins-recovery snapshot create pre-pif-upgrade-<backend>` |
| pif → eggs | [penguins-eggs](https://gitlab.com/openos-project/penguins-eggs_deving/penguins-eggs) | Post-upgrade | Notifies eggs via `EGGS_HOOK=pif-upgraded` so next ISO reflects new root |
...
| powerwash → pif | [penguins-powerwash](https://gitlab.com/openos-project/penguins-eggs_deving/penguins-powerwash) | Pre-reset | Exits mutable mode before factory reset |
